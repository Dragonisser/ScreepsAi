		    ...
		    if(tower) {
		        for(i = 0; i < tower.length; i++) {
		        	if(tower[i].energy > 500) {
			        	...
			        	var targets = roomName.find(FIND_STRUCTURES, {
		    		        filter: (structure) => {
		    	                        return (structure.structureType == STRUCTURE_RAMPART || structure.structureType == STRUCTURE_WALL || structure.structureType == STRUCTURE_ROAD)&&
